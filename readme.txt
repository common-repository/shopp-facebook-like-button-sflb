...
URI: http://www.shoppdeveloper.com
...
1. Dowload the right plugin zip-file. (Version 1.0 for Shopp 1.1.9, version 1.2 for Shopp 1.2.x, 1.3.2 for Shopp 1.3.x)
...
This 1.3.2 version of the plugin has been tested with Shopp 1.3.x. There are two other versions available one for Shopp version 1.1.x and one for Shopp version 1.2.x.
